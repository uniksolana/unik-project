...
const SolflareLogo = () => (
    <svg className="w-6 h-6 text-white" viewBox="0 0 119 119" fill="currentColor">
        <path d="M107.5 73.1a41.3 41.3 0 1 1-13.8-31l18.5-12.6A63.8 63.8 0 1 0 117.8 77L96.2 68.3A41.2 41.2 0 0 1 107.5 73.1Z" />
        <path d="M74.9 29.5L62.2 42 49 29.1a25.2 25.2 0 0 0-35.7 36L26.3 53a9 9 0 0 1 23-14.7L62.2 51l12.8-12.4A9 9 0 0 1 97.9 53L111 65.5A25.2 25.2 0 0 0 74.9 29.5Z" />
    </svg>
);
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-[#111116] border border-white/5 rounded-3xl p-8 max-w-sm w-full shadow-2xl flex flex-col items-center animate-in zoom-in-95 duration-300">
                <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-6">
                    <svg className="w-8 h-8 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                </div>

                <h3 className="text-2xl font-bold text-white mb-2 text-center">Mobile Browser Detected</h3>
                <p className="text-gray-400 text-center mb-8 text-sm leading-relaxed">
                    To connect your wallet securely and process transactions, please open this link directly in your mobile wallet app.
                </p>

                <div className="flex flex-col w-full gap-4">
                    <a
                        href={getDeepLink(urlToUse, 'phantom')}
                        className="flex items-center justify-center gap-3 px-6 py-4 bg-[#5546FF] rounded-2xl font-bold text-lg text-white hover:bg-[#4536EE] active:scale-[0.98] transition-all w-full"
                    >
                        <PhantomLogo />
                        Open in Phantom
                    </a>
                    ...
                    <a
                        ...
                        className="flex items-center justify-center gap-3 px-6 py-4 bg-[#FC763A] rounded-2xl font-bold text-lg text-white hover:bg-[#EC662A] active:scale-[0.98] transition-all w-full"
                    >
                        <SolflareLogo />
                        Open in Solflare
                    </a>
